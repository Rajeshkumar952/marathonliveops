...
const seed={
  users:[
    {id:'admin',password:'admin123',role:'admin',name:'Project Admin'},
    {id:'ops',password:'ops123',role:'ops',name:'Rahul S.',department:'Race Course',zone:'Zone 03'},
    {id:'client',password:'client123',role:'client',name:'Client User'}
  ],
  project:{name:'Tata Steel World 25K Kolkata',eventDay:'Event Day - 02',readiness:78,lastUpdate:'04:47 AM'},
  departments:[
    {name:'Venue',progress:88,status:'On Track'},{name:'Race Course',progress:68,status:'Working'},
    {name:'Hydration',progress:74,status:'Working'},{name:'Medical',progress:91,status:'On Track'},
    {name:'Security',progress:82,status:'On Track'},{name:'Logistics',progress:63,status:'Attention'},
    {name:'Expo',progress:100,status:'Completed'},{name:'Branding',progress:79,status:'Working'}
  ],
  tasks:[
    {id:'RC-118',name:'KM 12 Directional Signage',phase:'Race Course',department:'Race Course',zone:'Zone 03',assignedTo:'ops',priority:'Critical',status:'Not Started',deadline:'04:45 AM',progress:0,clientVisibility:'Status + Approved Proof',instruction:'Install directional board facing runner flow. Confirm alignment and safety.',proofMin:3,verification:true,proofs:[],remark:'',issue:'',verified:false,fields:[
      {label:'Current Status',type:'dropdown',required:true,opsEdit:true,client:'Status',options:['Not Started','Just Started','Working','Unable to Start','Blocked','Delayed','Finished']},
      {label:'% Complete',type:'number',required:true,opsEdit:true,client:'Yes'},
      {label:'Specific Location',type:'text',required:true,opsEdit:true,client:'No'},
      {label:'Issue / Delay',type:'dropdown',required:true,opsEdit:true,client:'No',options:['No','Material Not Reached','Manpower Shortage','Vehicle Delay','Permission Issue','Safety Issue','Other']},
      {label:'Update Remark',type:'remark',required:true,opsEdit:true,client:'No'}
    ]},
    {id:'RC-119',name:'Barricade Check Z3',phase:'Race Course',department:'Race Course',zone:'Zone 03',assignedTo:'ops',priority:'High',status:'Working',deadline:'05:00 AM',progress:55,clientVisibility:'Status Only',instruction:'Check barricade continuity and runner safety.',proofMin:2,verification:true,proofs:[],remark:'',issue:'',verified:false,fields:[]},
    {id:'VN-201',name:'Finish Gate Branding',phase:'Venue',department:'Venue',zone:'Finish',assignedTo:'ops',priority:'High',status:'Finished',deadline:'04:10 AM',progress:100,clientVisibility:'Status + Approved Proof',instruction:'Final branding alignment check.',proofMin:2,verification:true,proofs:[],remark:'Completed and aligned.',issue:'',verified:false,fields:[]},
    {id:'HY-044',name:'Hydration Station H6',phase:'Race Course',department:'Hydration',zone:'KM 15',assignedTo:'ops',priority:'Medium',status:'Finished',deadline:'04:25 AM',progress:100,clientVisibility:'Status + Approved Proof',instruction:'Verify water, cups and volunteer readiness.',proofMin:1,verification:true,proofs:[],remark:'Ready.',issue:'',verified:true,fields:[]}
  ],
  team:[
    {name:'Rahul S.',userId:'ops',role:'Supervisor',department:'Race Course',zone:'Zone 03',access:'Assigned Only',status:'Active'},
    {name:'Priya M.',userId:'priya',role:'Coordinator',department:'Venue',zone:'Finish',access:'Department',status:'Active'},
    {name:'Amit K.',userId:'amit',role:'Lead',department:'Logistics',zone:'All',access:'Department',status:'Active'},
    {name:'Neha R.',userId:'neha',role:'Verifier',department:'Admin Ops',zone:'All',access:'Proof Only',status:'Active'}
  ],
  messages:[
    {thread:'RC-118',from:'ops',to:'admin',text:'Directional board has not reached the location.',time:'04:11 AM'},
    {thread:'RC-118',from:'admin',to:'ops',text:'Vehicle 04 is approaching. ETA 12 minutes.',time:'04:13 AM'},
    {thread:'client-artwork',from:'admin',to:'client',text:'Please review the revised artwork uploaded for approval.',time:'10:32 AM'},
    {thread:'client-artwork',from:'client',to:'admin',text:'Looks good. Please proceed with this version.',time:'10:41 AM'}
  ],
  approvals:[
    {id:'AP-1',title:'Start Gate Artwork',type:'Approve artwork',status:'Pending',note:'Please approve the final start gate artwork for production.'},
    {id:'AP-2',title:'Sponsor Logo Pack',type:'Upload file',status:'Pending',note:'Please provide the latest sponsor logo pack.'},
    {id:'AP-3',title:'Finish Branding',type:'Approval',status:'Approved',note:'Approved.'}
  ],
  issues:[
    {id:'IS-1',task:'RC-118',title:'Material not reached',severity:'High',status:'Open',time:'04:11 AM'},
    {id:'IS-2',task:'LG-08',title:'Water vehicle arrival delayed',severity:'Medium',status:'Open',time:'04:12 AM'}
  ],
...
function navigate(page){session.page=page;$$('[data-page]','#sidebar').forEach(b=>b.classList.toggle('active',b.dataset.page===page));const render=pages[page]||pages.notFound;render()}
